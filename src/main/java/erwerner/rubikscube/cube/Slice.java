...
/**
 * Ein Slice bildet ein Array aus allen 9 Slots einer Wuerfelseite. Er wird zur
 * Darstellung im GUI und Drehung einer Seite verwendet.
 * 
 * @see StoneSlot
 * @see Dim
 * @version 0.1
...
public class Slice implements iSlice {
	 ...
	 *                <br>
	 *               Die Seite der Dimension LEFT übergibt folgende Slots aus dem  
	 *               Grid: <br>
